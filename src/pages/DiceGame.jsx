...
const DiceGame = () => {
    ...
    const handleStartGame = () => {
        ...
        setTimeout(() => {
            ...
            setRolling(false);
            setTimeout(() => declareWinner(randomValue), 100);
        }, 1000);
    };
    ...
    return (
        <div style={{ textAlign: 'center', padding: '50px', backgroundColor: '#f4f4f4' }}>
            ...
            <button disabled={rolling} onClick={handleStartGame} style={{
                marginTop: '20px',
                padding: '10px 20px',
                backgroundColor: rolling ? 'gray' : '#28a745',
                cursor: rolling ? 'not-allowed' : 'cursor',
                color: '#fff',
                border: 'none',
                borderRadius: '5px',
                marginBottom: '20px',
